# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-03-11 08:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='GoodsSkuWareHouse',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stock', models.IntegerField(default=0, null=True, verbose_name='商品库存')),
                ('goodssku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsSKU', verbose_name='库存商品')),
            ],
            options={
                'verbose_name': '商品库存',
        ...
        migrations.AddField(
            model_name='goodsskuwarehouse',
            name='warehouse',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Warehouse', verbose_name='仓库'),
        ),
        migrations.AddField(
            model_name='goodssku',
            name='type',
